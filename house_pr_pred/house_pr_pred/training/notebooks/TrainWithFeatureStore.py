...
# ``house_pr_pred/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-house_pr_pred-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.house_pr_pred.house_pr_pred-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.house_pr_pred.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.house_pr_pred.trip_dropoff_features",
