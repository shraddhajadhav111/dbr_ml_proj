...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/house_pr_pred-tests-ci.yml) 
...
* [Staging model in UC](https://adb-807190339831733.13.azuredatabricks.net/explore/data/models/staging/house_pr_pred/house_pr_pred-model)
* [Prod model in UC](https://adb-8041201319684568.8.azuredatabricks.net/explore/data/models/prod/house_pr_pred/house_pr_pred-model)
. 
